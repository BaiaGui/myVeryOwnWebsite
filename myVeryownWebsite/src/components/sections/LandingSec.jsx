            ...
            <div className="flex flex-col bg-gradient-to-b from-amber-100 to-amber-700/5 md:h-screen">
                ...
                <div className="flex flex-col items-center h-full md:flex-row-reverse p-8 xl:px-72">
                    <div className="md:w-1/2 flex justify-center">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRt33mnb3mYDSDAH9deKqcB5GMug-caGeqWdHiARd4pkBjVG8tXy7ll7PJp0HnDhm9IK2c&usqp=CAU" alt="Selfie" className="flex rounded-full md:w-2/3" />
                    </div>
                    <div className="flex flex-col justify-center items-center  md:items-start md:w-1/2">
                        ...
                        <h2 className="w-fit mt-4 text-center md:text-start text-sm text-stone-600">Estou aqui para ajudar empresas a se exporem na internet de maneira simples, acessível e rápida. Conheça mais sobre meu trabalho!</h2>
