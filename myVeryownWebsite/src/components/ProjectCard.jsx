    ...
    return (
        <HoverCard.Root openDelay={100} closeDelay={100}>
            <HoverCard.Trigger asChild>
                <a href={project.deployLink} target='_blank' className='w-fit h-fit'>
                    <img src={project.thumbnail} alt="" className='aspect-video rounded-sm ring-amber-700/20 hover:ring-4 transition-all duration-75' />
                </a>
            </HoverCard.Trigger>
            <HoverCard.Portal>
